    ...
    methods
        ...
        function initUML(obj, x0,xrange, n_samples )
            ...
            par.alpha = struct(...
                ...
                'N',n_samples,...         %number of alpha values. If this value is set to be 1, then the first element of alpha.limits would be the assumed alpha and the alpha parameter is not estimated.
            ...
            par.beta = struct(...
                ...
                'N',n_samples,...         %number of beta values. If this value is set to be 1, then the first element of beta.limits would be the assumed beta and the beta parameter is not estimated.
            ...
            par.lambda = struct(...
                ...
                'N',1,...                 %number of lambda values. If this value is set to be 1, then the first element of lambda.limits would be the assumed lambda and the lambda parameter is not estimated.
                'scale','lin',...         %the linear or log spacing. Choose between 'lin' and 'log'.
        ...
        function saveData(obj,filename)
            ...
            seq = obj.seq;
            resp = obj.resp;
            trials = [seq(1:size((obj.resp),1),:), resp];
            ...
            aData = obj.aData;
            u = obj.u;
            save(['data' filesep filename],'trials','expInfo','aData','seq','resp','u');
            csvwrite(['data', filesep, filename,'.txt'],trials);
        end
