...
% Exp.3. Using motivation to manipulate search slope
% favoriate 'target present'
...
try 
    ...
    for iTrl=1: exp.maxTrls
        ...
        % incentive feedback
        if key == c_target && c_target==1 % correctly identify target-present
    ...
    exp.saveData(['exp3_', exp.sName]);   %save data
